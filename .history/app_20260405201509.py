...
if page == "State Overview":
    ...
    for bar, val in zip(bars, filtered["people_per_salon"]):
        ax.text(bar.get_x() + bar.get_width()/2, bar.get_height() + 8,
                f"1:{val}", ha="center", va="bottom", fontsize=8, color="#888")
    ...
    ax.legend(handles=[wave1, wave2, nat], fontsize=9, facecolor="#1a1a1a", edgecolor="#2a2a2a")
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if len(compare_data) > 0:
        ...
        fig3, ax3 = plt.subplots(figsize=(9, max(3, len(compare_data) * 0.45)))
        bar_colors = []
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if len(df) > 0:
        ...
        ax4.legend(facecolor="#1a1a1a", edgecolor="#2a2a2a", fontsize=9)
